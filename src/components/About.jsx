...
function About() {
  const highlights = [
    ...
    { icon: '🎯', title: 'Focus', desc: 'Impact-Driven Engineering.' },
  ];

  return (
    <section
      className="font-aeonik relative min-h-screen snap-start bg-white font-normal"
      id="about"
    >
      ...
      <div className="grid min-h-screen lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center bg-gray-900 p-12 text-white">
          <div className="max-w-lg">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <button className="cursor-pointer rounded-lg bg-blue-600 px-8 py-3 text-white transition-colors hover:bg-blue-700">
                <a
              ...
              <button className="cursor-pointer rounded-lg border border-gray-600 px-8 py-3 text-gray-300 transition-colors hover:border-gray-400 hover:text-white">
        ...
        <div className="flex flex-col justify-center bg-gray-50 p-10">
          <div className="mx-auto max-w-lg">
            ...
            {/* Quote */}
            <motion.div
              className="mt-12 rounded-2xl bg-white p-6 shadow-md"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.2, duration: 0.6 }}
              viewport={{ once: true }}
